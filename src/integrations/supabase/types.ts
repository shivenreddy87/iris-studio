  ...
  public: {
    ...
    Enums: {
      ...
      contest_status:
        ...
        | "completed"
        | "archived";
      contest_submission_status: "pending" | "submitted" | "verified" | "flagged";
...
export const Constants = {
  public: {
    Enums: {
      ...
      campaign_status: ["draft", "live", "review", "completed", "archived"],
      contest_application_status: ["submitted", "withdrawn", "shortlisted", "selected", "rejected"],
      contest_status: [
        "draft",
        "published",
        "applications_open",
      ...
      contract_status: ["none", "draft", "sent", "signed"],
      creator_accent: ["violet", "rose"],
      deal_stage: ["invited", "negotiating", "agreed", "in_production", "delivered", "cancelled"],
      msg_sender_role: ["brand", "creator", "iris"],
      notification_kind: ["message", "deal_update", "invitation", "system"],
      participation_status: ["active", "removed", "completed"],
      payout_status: [
