...
export const Route = createFileRoute("/app/business/requests/$requestId")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Review the details, status and contest outcome of a campaign request." },
      { property: "og:title", content: "Campaign Request — Iris Studio" },
      { property: "og:description", content: "Review the details, status and contest outcome of a campaign request." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
    ],
  }),
  component: CampaignRequestDetailPage,
});

function CampaignRequestDetailPage() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 lg:px-8">
      <PageHeader eyebrow="Business" title="Campaign Request" description="Full brief, review history and the contest generated from this request." />
      <EmptyState
