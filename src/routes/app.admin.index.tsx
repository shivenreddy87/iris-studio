...
export const Route = createFileRoute("/app/admin/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Operational overview of businesses, requests, contests and payouts." },
      { property: "og:title", content: "Admin Dashboard — Iris Studio" },
      { property: "og:description", content: "Operational overview of businesses, requests, contests and payouts." },
...
function AdminDashboardPage() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 lg:px-8">
      <PageHeader eyebrow="Admin" title="Admin Dashboard" description="Review queue, running contests and pending payouts at a glance." />
      <EmptyState
