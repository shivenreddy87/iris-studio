  ...
  return (
    <div className="hero-dark min-h-screen font-geist text-foreground">
      <div className="mx-auto max-w-3xl px-6 py-20">
        ...
        <h1 className="mt-8 font-display text-5xl font-extrabold tracking-tight">
          Terms of Service
        </h1>
        ...
        <div className="prose prose-invert mt-10 max-w-none space-y-6 text-foreground/80">
          <section>
            ...
            <p>
              Don't post unlawful, harassing, or infringing content. Don't misrepresent identities
          ...
          <section>
            ...
            <p>
              We aim for high uptime but the service is provided "as is" without warranties. Notice
              of scheduled maintenance will be posted where reasonably possible.
            </p>
          </section>
          <section>
